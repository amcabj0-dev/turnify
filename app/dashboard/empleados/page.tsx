        ...
        <div style={{ maxWidth: '640px', margin: '0 auto', padding: '16px' }}>
            ...
            <div style={{ background: 'var(--bg-secondary)', border: '1px solid rgba(79,142,247,0.3)', borderRadius: '16px', padding: '20px', marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                <div>
                  ...
                  <input className="input-field" type="text" placeholder="Ej: María González" value={form.nombre}
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '48px 0', background: 'var(--bg-secondary)', border: '1px solid var(--border-card)', borderRadius: '16px' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '4px' }}>No tenés empleados todavía</p>
              <p style={{ color: 'var(--text-secondary)', fontSize: '12px', opacity: 0.6 }}>Agregá tu primer empleado para empezar</p>
            </div>
          ) : (
