    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .modal-sheet { background: #0f1628; border-radius: 20px 20px 0 0; border-top: 1px solid rgba(79,142,247,0.2); width: 100%; max-width: 480px; max-height: 88vh; overflow-y: auto; padding: 20px 16px 40px; animation: slideUp 0.25s ease; }
              ...
              <div key={cliente.id} className="cliente-card" onClick={() => abrirCliente(cliente)}>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '10px', paddingTop: '10px', borderTop: '1px solid rgba(79,142,247,0.08)' }}>
                  ...
                  <div style={{ flex: 2, textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: '10px', color: '#6b7fa3' }}>ultimo turno</div>
                  </div>
                </div>
              </div>
            ))
          ...
          <div className="modal-sheet">
            ...
            {!editando ? (
              <>
                ...
                <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '13px', marginBottom: '10px' }}>Historial de turnos</div>
                ...
                {!confirmEliminar ? (
                  ...
                  <div style={{ marginTop: '16px', background: 'rgba(255,107,107,0.08)', border: '1px solid rgba(255,107,107,0.25)', borderRadius: '12px', padding: '14px', textAlign: 'center' }}>
                    ...
                    <div style={{ fontSize: '11px', color: '#6b7fa3', marginBottom: '12px' }}>Se eliminara el cliente pero sus turnos quedaran en el sistema.</div>
              ...
              <>
                ...
                <div style={{ display: 'flex', gap: '8px', marginTop: '20px' }}>
                  <button className="action-btn" onClick={() => setEditando(false)} style={{ flex: 1, background: 'rgba(79,142,247,0.08)', color: '#6b7fa3', border: '1px solid rgba(79,142,247,0.15)' }}>
                    Cancelar
                  </button>
      ...
      <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, background: '#0f1628', borderTop: '1px solid rgba(79,142,247,0.15)', display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: '10px 0 14px', zIndex: 100 }}>
        ...
        <Link href="/dashboard/configuracion" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3px', color: '#6b7fa3', fontSize: '9px', fontFamily: "'DM Sans', sans-serif", textDecoration: 'none' }}>
