        ...
        {loading ? (
          ...
          <div className="flex flex-col gap-3">
            {servicios.map((servicio) => (
              <div key={servicio.id} className="bg-[#1a1a1a] border border-white/10 rounded-2xl px-6 py-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <div className={`w-3 h-3 rounded-full ${servicio.activo ? 'bg-[#c8f135]' : 'bg-gray-600'}`} />
                  <div>
