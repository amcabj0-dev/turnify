      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <div style={{ maxWidth: '640px', margin: '0 auto', padding: '16px' }}>
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '13px', marginTop: '4px' }}>Agregá los servicios que ofrece tu negocio</p>
          </div>
            ...
            <div style={{ background: 'var(--bg-secondary)', border: '1px solid rgba(79,142,247,0.3)', borderRadius: '16px', padding: '20px', marginBottom: '16px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                  <div>
                    <div style={{ fontSize: '12px', color: 'var(--text-secondary)', marginBottom: '6px' }}>Duracion (minutos)</div>
          ...
          {loading ? (
            ...
            <div style={{ textAlign: 'center', padding: '48px 0', background: 'var(--bg-secondary)', border: '1px solid var(--border-card)', borderRadius: '16px' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '14px', marginBottom: '4px' }}>No tenes servicios todavia</p>
              <p style={{ color: 'var(--text-secondary)', fontSize: '12px', opacity: 0.6 }}>Agrega tu primer servicio para empezar</p>
            </div>
          ) : (
